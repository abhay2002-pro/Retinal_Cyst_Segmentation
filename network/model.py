...
# Model Encoder
#
class ModelEncoderNet(nn.Module):
    def __init__(self, features):
        super(ModelEncoderNet, self).__init__()
...
# Model Decoder
#
class ModelDecoderNet(nn.Module):
    def __init__(self, features):
        super(ModelDecoderNet, self).__init__()
        self.features = features
...
class ModelNet(nn.Module):
    '''ModelNet a Siamese Encoder-Decoder for Object Co-segmentation.'''
    def __init__(self, input_size=512, init_weights=True, batch_norm=False, 
        ...
        self.encoder = ModelEncoderNet(en_layers)
        ...
        self.decoder = ModelDecoderNet(de_layers)
